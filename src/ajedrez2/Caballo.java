...
/**
 * Puede moverse: El caballo puede moverse siempre que el número de casillas que se mueve en horizontal sea, en valor absoluto = 2 y el vertical 1,
 * o el horizontal sea 1 y el vertical 2.
 * Puede moverse, versión alternativa (comentada en código). El caballo podrá moverse siempre y cuando el movimiento introducido por el
