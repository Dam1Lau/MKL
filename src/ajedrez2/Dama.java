...
public class Dama extends Pieza {
    ...
    /**
     * Constructor por defecto para Dama. Inicializa su nombre a Dama, color a
     * blanca y puntos a 10.
     */
    public Dama() {
        nombre = "Reina";
        color = "Blanca";
    ...
    /**
     * Puede Moverse: La reina o dama podrá moverse en diagonal, horizontal o
     * vertical tantas casillas como el usuario introduzca.
     *
